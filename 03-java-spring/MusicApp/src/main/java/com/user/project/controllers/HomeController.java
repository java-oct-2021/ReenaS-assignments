...
//			aService.deleteProject(id);
//			return "redirect:/projects";
//		}
//
//		// Edit- Page
//		@GetMapping("/projects/edit/{id}")
//		public String edit(@PathVariable("id") Long id, @ModelAttribute("editedProject") Album project, Model model,
//				HttpSession session) {
//			Album editProject = aService.getOneProject(id);
...
//		public String update(@PathVariable("id") Long id, @Valid @ModelAttribute("editedProject") Album project,
...
//				return "edit.jsp";
//			} else {
//				Album newProject = aService.updateProject(id, project.getAlbumName(), project.getDescription());
//				return "redirect:/projects";
//
//			}
//		}
